...
const CLIENTID_INPUT = 'input[id="consumerKey"]';
...
const clientID_input = () => cy.contains(CLIENTID_INPUT);

//EXPORT METHODS 
module.exports = { 
    playground_page_title, grant_type, select_implicit, clientID_label, clientID_input
