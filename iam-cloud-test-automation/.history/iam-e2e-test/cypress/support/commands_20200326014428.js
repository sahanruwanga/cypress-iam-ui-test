...
Cypress.Commands.add('xml2js', () => {
   cy.readFile('cypress/fixtures/saml_sso.txt', (err,data) => {
parser.parseString(data, (err, result) =>{
    cy.writeFile('cypress/fixtures/saml_response.json', util.inspect(result,false,null,true));
    cy.log( util.inspect(result,false,null,true));
})
   })
})
