...
const FIRST_NAME = '[name=http://wso2.org/claims/givenname]';
...
const first_name = () => cy.get(FIRST_NAME).should('have.attr', 'required', "");

//EXPORT METHODS 
module.exports = { 
    create_user,  enater_new_username , sr_form_title , username_label , newuser_form_title , new_user_form_label , first_name  }