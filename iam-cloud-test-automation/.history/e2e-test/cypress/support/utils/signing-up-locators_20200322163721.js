...
//EXPORT METHODS 
module.exports = { 
  oraganization,  email, password , last_name , first_name : FIRST_NAME, create_user,  enater_new_username , sr_form_title , username_label , newuser_form_title , new_user_form_label , first_name  }