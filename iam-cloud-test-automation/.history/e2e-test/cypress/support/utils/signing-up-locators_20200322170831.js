...
const IM = 'input[name="http://wso2.org/claims/im"]';
const COUNTRY = 'input[name="http://wso2.org/claims/country"]';
const MOBILE = 'input[name="http://wso2.org/claims/mobile"]';
const URL = 'input[name="http://wso2.org/claims/url"]';
const CHECK_POLICY = 'input[type="checkbox"]';
...
//EXPORT METHODS 
module.exports = { 
  check_policy, url, mobile, country, im, telephone, oraganization,  email, password , last_name , first_name : FIRST_NAME, 
