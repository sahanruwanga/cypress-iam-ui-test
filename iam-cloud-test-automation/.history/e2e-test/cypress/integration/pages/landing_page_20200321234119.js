import * as loadingPageLocators from '../../support/utils/landing-page-locators.js'
...
class LandingPage {
    ...
    getinItialLocators(){
       ...
       loadingPageLocators.project_title_locator().should('eq',loadingPageLocators.project_title);//.should('eq',loadingPageLocators.priject_title);
    }
