import * as portalLandingPageLocators from '../../../support/utils/automation-utils/user-portal-landing-page-locators'
var title = require('../../../support/utils/automation-utils/user-portal-landing-page-locators.js');
class LandingPage {
    ...
    getPageTitle(title){
      //  return cy.title().should('eq', );
      it('Switching context to iFrame', () => {
        
        
    
        
       cy.log(title.pageTitle);
